...
static void build_and_verify_dvcs(void){
    ...
    snprintf(command, sizeof(command),
             ...
             "-o \"%s\" -lbcrypt\"",
             gcc, root, root, root, root, root, root, output);
    ...
    snprintf(path, sizeof(path), "%s\\.axi\\wrap-manifest.json", fixture);
    stream = fopen(path, "wb");
