# [ETHOS-NOMOS-101] [Migration #483] Define connector confidentiality exposure governance
...
Define a confidentiality exposure matrix for agents, workflows, and connectors.

## Bounded scope

- Define a confidentiality exposure matrix for agents, workflows, and connectors.
- Preserve source lineage through https://github.com/The-Ethos-Project/ethos-logos/issues/31 and migration `Chris-Cheeseman/cogni-core#483`.
- Coordinate with the owner-repository baseline issue https://github.com/The-Ethos-Project/ethos-nomos/issues/96.

## Dependencies

- Current live evidence: https://github.com/The-Ethos-Project/ethos-logos/issues/31

## Acceptance criteria

- A reviewable matrix classifies data classes, actors, transports, storage, logging, retention, and approval controls without containing secrets.
...
- **Scope:** GitHub Labels: type:governance, type:discovery, risk:high, status:blocked | Original Repo: The-Ethos-Project/ethos-nomos
