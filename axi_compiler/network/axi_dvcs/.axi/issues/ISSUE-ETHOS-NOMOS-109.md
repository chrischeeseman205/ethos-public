# [ETHOS-NOMOS-109] [Migration #697] Define historical-evidence archive placement and retention
...
Define decision-only archive placement and retention policy without moving or deleting evidence.

## Bounded scope

- Define decision-only archive placement and retention policy without moving or deleting evidence.
- Preserve source lineage through https://github.com/The-Ethos-Project/cogni-core/issues/20 and migration `Chris-Cheeseman/cogni-core#697`.
- Coordinate with the owner-repository baseline issue https://github.com/The-Ethos-Project/ethos-nomos/issues/96.

## Dependencies

- Current live evidence: https://github.com/The-Ethos-Project/cogni-core/issues/20

## Acceptance criteria

- A policy matrix names evidence classes, canonical locations, retention, access, deletion prohibitions, and later execution approvals.
