# [ISSUE-049] [Migration #466] Verify local-default environment documentation
...
- **Scope:** GitHub Labels: documentation, type:discovery, risk:planning-only, sync:nomos, status:blocked
