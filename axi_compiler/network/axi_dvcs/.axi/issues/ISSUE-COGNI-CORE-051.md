# [COGNI-CORE-051] [Migration #612] Establish canonical anatomy registry and completeness audit
...
Establish a planning-only registry and completeness audit for protected component anatomy.

## Bounded scope

- Establish a planning-only registry and completeness audit for protected component anatomy.
- Preserve source lineage through https://github.com/The-Ethos-Project/ethos-logos/issues/16 and migration `Chris-Cheeseman/cogni-core#612`.
- Coordinate with the owner-repository baseline issue https://github.com/The-Ethos-Project/cogni-core/issues/46.

## Dependencies

- Current live evidence: https://github.com/The-Ethos-Project/ethos-logos/issues/16

## Acceptance criteria

- A reviewable registry schema names components, authority, lineage, lifecycle, relationships, completeness evidence, and unresolved gaps.
...
- **Scope:** GitHub Labels: type:governance, type:discovery, risk:protected-core, sync:nomos, status:blocked | Original Repo: The-Ethos-Project/cogni-core
