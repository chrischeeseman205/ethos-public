# [ETHOS-NOMOS-103] [Migration #503] Define incident-response workflow standard
...
Define a reusable incident-response governance workflow without operating an incident system.

## Bounded scope

- Define a reusable incident-response governance workflow without operating an incident system.
- Preserve source lineage through https://github.com/The-Ethos-Project/ethos-logos/issues/30 and migration `Chris-Cheeseman/cogni-core#503`.
- Coordinate with the owner-repository baseline issue https://github.com/The-Ethos-Project/ethos-nomos/issues/96.

## Dependencies

- Current live evidence: https://github.com/The-Ethos-Project/ethos-logos/issues/30

## Acceptance criteria

- A workflow contract covers severity, authority, evidence preservation, containment approvals, communication, recovery, and review.
...
- **Scope:** GitHub Labels: type:governance, risk:high, status:blocked | Original Repo: The-Ethos-Project/ethos-nomos
