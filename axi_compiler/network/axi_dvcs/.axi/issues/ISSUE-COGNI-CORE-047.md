# [COGNI-CORE-047] [Migration #313] Plan staged Cogni-Core technical rename compatibility
...
Define a staged rename and compatibility boundary without modifying canonical names or runtime identifiers.

## Bounded scope

- Define a staged rename and compatibility boundary without modifying canonical names or runtime identifiers.
- Preserve source lineage through https://github.com/The-Ethos-Project/ethos-nomos/issues/84 and migration `Chris-Cheeseman/cogni-core#313`.
- Coordinate with the owner-repository baseline issue https://github.com/The-Ethos-Project/cogni-core/issues/46.

## Dependencies

- Current live evidence: https://github.com/The-Ethos-Project/ethos-nomos/issues/84

## Acceptance criteria

- A mapping of canonical names, temporary aliases, consumers, rollback conditions, and approval gates is reviewable.
...
- **Scope:** GitHub Labels: type:governance, type:migration, risk:protected-core, sync:nomos, status:blocked | Original Repo: The-Ethos-Project/cogni-core
