# [COGNI-CORE-048] [Migration #329] Clarify developmental engine and gate authority naming
...
Resolve terminology at the protected authority boundary without changing the pipeline.

## Bounded scope

- Resolve terminology at the protected authority boundary without changing the pipeline.
- Preserve source lineage through https://github.com/The-Ethos-Project/ethos-logos/issues/49 and migration `Chris-Cheeseman/cogni-core#329`.
- Coordinate with the owner-repository baseline issue https://github.com/The-Ethos-Project/cogni-core/issues/46.

## Dependencies

- Current live evidence: https://github.com/The-Ethos-Project/ethos-logos/issues/49

## Acceptance criteria

- A normative glossary distinguishes engine, gate, authority, and developmental-stage meanings with precedence references.
