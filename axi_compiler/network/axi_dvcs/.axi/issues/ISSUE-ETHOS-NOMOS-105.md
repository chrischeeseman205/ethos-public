# [ETHOS-NOMOS-105] [Migration #528] Define documentation-surface policy
...
Define authority, lifecycle, and publication rules for repository, wiki, and pages documentation surfaces.

## Bounded scope

- Define authority, lifecycle, and publication rules for repository, wiki, and pages documentation surfaces.
- Preserve source lineage through https://github.com/The-Ethos-Project/ethos-logos/issues/27 and migration `Chris-Cheeseman/cogni-core#528`.
- Coordinate with the owner-repository baseline issue https://github.com/The-Ethos-Project/ethos-nomos/issues/96.

## Dependencies

- Current live evidence: https://github.com/The-Ethos-Project/ethos-logos/issues/27

## Acceptance criteria

- A policy matrix names canonical owners, draft/publish states, synchronization rules, retention, and conflict precedence.
...
- **Scope:** GitHub Labels: documentation, type:governance, risk:planning-only, status:blocked | Original Repo: The-Ethos-Project/ethos-nomos
