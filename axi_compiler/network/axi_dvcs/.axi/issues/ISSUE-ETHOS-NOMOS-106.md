# [ETHOS-NOMOS-106] [Migration #561] Govern subscription tiers and business metrics
...
Define governance inputs for tiered subscriptions and business-plan metrics without setting prices or launching a product.

## Bounded scope

- Define governance inputs for tiered subscriptions and business-plan metrics without setting prices or launching a product.
- Preserve source lineage through https://github.com/The-Ethos-Project/ethos-products/issues/24 and migration `Chris-Cheeseman/cogni-core#561`.
- Coordinate with the owner-repository baseline issue https://github.com/The-Ethos-Project/ethos-nomos/issues/96.

## Dependencies

- Current live evidence: https://github.com/The-Ethos-Project/ethos-products/issues/24

## Acceptance criteria

- A reviewable model names measurement definitions, decision owners, uncertainty, privacy constraints, and later Product handoffs.
...
- **Scope:** GitHub Labels: type:governance, type:product-design, risk:planning-only, status:blocked | Original Repo: The-Ethos-Project/ethos-nomos
