# [ETHOS-NOMOS-108] [Migration #607] Govern generative code-construction workflow
...
Define governance for generative construction without granting tools direct cognitive or deployment authority.

## Bounded scope

- Define governance for generative construction without granting tools direct cognitive or deployment authority.
- Preserve source lineage through https://github.com/The-Ethos-Project/ethos-logos/issues/17 and migration `Chris-Cheeseman/cogni-core#607`.
- Coordinate with the owner-repository baseline issue https://github.com/The-Ethos-Project/ethos-nomos/issues/96.

## Dependencies

- Current live evidence: https://github.com/The-Ethos-Project/ethos-logos/issues/17

## Acceptance criteria

- A workflow contract defines intent, provenance, review, test, approval, execution, rollback, and prohibited bypass paths.
...
- **Scope:** GitHub Labels: type:governance, risk:protected-core, status:blocked | Original Repo: The-Ethos-Project/ethos-nomos
