// =====================================================================
// MODULE: tests::test_ast_boundary
...
HOW TO start():
    WRITE "=== INITIATING AST COMPLIANCE BOUNDARY TESTS ===" TO SCREEN
    c_call("run_compliance_tests")
    WRITE "=== AST TESTS COMPLETE ===" TO SCREEN

run_compliance_tests -> start
